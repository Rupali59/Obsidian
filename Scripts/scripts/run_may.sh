...
# Run parallel GitHub metrics capture for May 2025
# This script processes only the repositories marked with 'X' in repos_to_track.env

echo "🚀 May 2025 GitHub Capture (Parallel)"
echo "========================================"
...
python3 "$(dirname "$0")/runner.py" "$OBSIDIAN_PATH" "configs/may_2025.json"

echo "✅ May 2025 parallel capture completed!"
